        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            if (adminUserForHost == null)
            {
                var user = new User
                {
                    ...
                    Name = "quan",
                    Surname = "nguyen",
                    EmailAddress = "quannguyennak@gmail.com",
                    IsEmailConfirmed = true,
                    IsActive = true
                };

                user.Password = new PasswordHasher<User>(new OptionsWrapper<PasswordHasherOptions>(new PasswordHasherOptions())).HashPassword(user, "!234Abcd~");
