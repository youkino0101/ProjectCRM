...
export interface IGoodsReceiptDto {
    id: number;
    orderCode: string;
    warehouse: string;
    staffName: string;
...
export class GoodsReceiptDto  implements IGoodsReceiptDto {
    id: number;
    orderCode: string;
    warehouse: string;
    staffName: string;
    ...
    constructor(data?: GoodsReceiptDto) {
        if (data) {
    ...
    static fromJS(data: any): GoodsReceiptDto {
        data = typeof data === 'object' ? data : {};
        let result = new GoodsReceiptDto();
        result.init(data);
        return result;
    }
